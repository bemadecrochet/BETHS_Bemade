...
const SEEN_KEY = 'bb_whatsapp_tip_seen'
...
export default function WhatsAppButton() {
  ...
  useEffect(() => {
    ...
    const showTimer = setTimeout(() => setShowTip(true), 2500)
  ...
  return (
    ...
    >
      ...
      <a
        ...
        onClick={dismissTip}
        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:-translate-y-0.5 hover:shadow-xl"
      >
        ...
        />
        <svg viewBox="0 0 32 32" width="28" height="28" fill="currentColor" className="relative" aria-hidden="true">
